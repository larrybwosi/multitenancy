  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        active:
          "border-transparent bg-status-active text-status-active_foreground",
        inactive:
          "border-transparent bg-status-inactive text-status-inactive_foreground",
        // Add more custom variants if needed (e.g., loyalty tiers)
