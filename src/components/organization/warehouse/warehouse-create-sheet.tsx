          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="123 Main St, New York, NY" {...field} className="shadow-sm" />
                        </FormControl>
              ...
              <div className="p-4 bg-muted/40 rounded-lg border border-border/50">
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="flex items-center space-x-2 space-y-0">
                              ...
                              <FormLabel className="text-sm font-normal cursor-pointer">Enable capacity tracking</FormLabel>
                            </FormItem>
                          )}
                        />
                      </TooltipTrigger>
                ...
                <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 ${!capacityTrackingEnabled ? "opacity-50 pointer-events-none" : ""}`}>
                  <FormField
                    control={form.control}
                    name="totalCapacity"
                    render={({ field }) => (
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="clk123..." {...field} value={field.value ?? ''} className="shadow-sm" />
                      </FormControl>
