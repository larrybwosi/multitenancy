...
// Define weight and dimension units
const dimensionUnits = ['cm', 'inches', 'mm', 'm', 'feet'];
  ...
  const onSubmit = async (data: OrganizationFormValues) => {
    ...
    try {
      ...
      const apiData = {
        ...
        settings: {
          ...data.settings,
          defaultTaxRate: data.settings.defaultTaxRate ? parseFloat(data.settings.defaultTaxRate as string) : null,
          lowStockThreshold: data.settings.lowStockThreshold ? parseInt(data.settings.lowStockThreshold as string) : 10,
        },
      };
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField
                      control={form.control}
                      name="settings.enableCapacityTracking"
                      render={({field}) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                          <div className="space-y-0.5">
                    ...
                    <FormField
                      control={form.control}
                      name="settings.enforceSpatialConstraints"
                      render={({field}) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                          <div className="space-y-0.5">
                  ...
                  <FormField
                    control={form.control}
                    name="settings.enableProductDimensions"
                    render={({field}) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <FormField
                      control={form.control}
                      name="settings.defaultMeasurementUnit"
                      render={({field}) => (
                        <FormItem>
                    ...
                    <FormField
                      control={form.control}
                      name="settings.defaultDimensionUnit"
                      render={({field}) => (
                        <FormItem>
                    ...
                    <FormField
                      control={form.control}
                      name="settings.defaultWeightUnit"
                      render={({field}) => (
                        <FormItem>
