...
const SignupPage = (props: {params: Params; searchParams: SearchParams}) => {
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 xl:px-20">
        <div className="max-w-md w-full mx-auto">
          ...
          <p className="mt-2 text-center text-sm text-gray-500">Join thousands of businesses managing their finances</p>
        </div>
