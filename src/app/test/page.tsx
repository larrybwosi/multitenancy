...
// Mock enum values that would come from your actual schema lowStockThreshold
            ...
            <div>
              ...
              <div className="bg-gray-50 p-3 rounded-md">
                <div className="flex items-center">
                  {formData.logo ? (
                    <img src={formData.logo} alt="Logo" className="h-10 w-10 rounded-md object-cover" />
                  ) : (
                      ...
                      <div className="sm:col-span-6">
                        <div className="flex items-start">
                          ...
                          <div className="ml-3 text-sm">
                            ...
                            <p className="text-gray-500">
                              Track physical dimensions and weight for products.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      {formData.enableProductDimensions && (
                        <>
                          <div className="sm:col-span-2">
                            ...
                            <p className="mt-1 text-xs text-gray-500">
                              Default unit for volume measurements.
                            </p>
                          </div>
                          ...
                          <div className="sm:col-span-2">
                            ...
                            <p className="mt-1 text-xs text-gray-500">
                              Default unit for length, width, height.
                            </p>
                          </div>
                          ...
                          <div className="sm:col-span-2">
                            ...
                            <p className="mt-1 text-xs text-gray-500">
                              Default unit for weight measurements.
                            </p>
                          </div>
                        </>
                      )}
