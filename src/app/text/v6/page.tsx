...
const YourSalesPerformanceReport = () => {
...
`; // Your provided markdown string (ensure it's just the markdown content)

  const reportFileName = 'SalesPerformanceReport_DealioInc.pdf';
...
export default YourSalesPerformanceReport; // Or App, if this is your main App component
