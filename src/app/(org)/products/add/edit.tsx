...
import { EditProductSchema, EditProductSchemaType } from '@/lib/validations/product';
...
export default function EditProductForm({ product }: { product: any }) {
  ...
  const onSubmit = async (values: EditProductSchemaType) => {
    ...
    Object.entries(values).forEach(([key, value]) => {
      if (key === 'variants' || key === 'suppliers' || key === 'imageUrls' || key === 'productId') return;
    ...
    startTransition(async () => {
      try {
        ...
        if (result?.error) {
          ...
          toast.error(result.error || 'Failed to update product. Please check errors.');
        } else {
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="lg:col-span-6 space-y-6">
                ...
                <Card className="bg-gradient-to-br from-background to-muted/20 shadow-md border-primary/10">
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>Update the physical characteristics of your product.</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
              ...
              <div className="lg:col-span-6 space-y-6">
                ...
                <Card className="bg-gradient-to-br from-background to-muted/20 shadow-md border-primary/10">
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>Update inventory management options.</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <FormField
                      control={form.control}
                ...
                <Card className="bg-gradient-to-br from-background to-muted/20 shadow-md border-primary/10">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-primary text-xl flex items-center justify-between">
                      ...
                      <Button type="button" variant="outline" onClick={() => setVariantModalOpen(true)} className="h-8">
                        Manage Variants
                      </Button>
                    </CardTitle>
                    <CardDescription>Update different variations of your product.</CardDescription>
                  </CardHeader>
                  <CardContent>
                        ...
                        {variantFields.map((field, index) => (
                          ...
                          >
                            ...
                            <div className="mt-1 text-sm text-muted-foreground">
                              ...
                              <div className="flex justify-between">
                                <span>
                                  Reorder: {field.reorderPoint} / {field.reorderQty}
                                </span>
                ...
                <Card className="bg-gradient-to-br from-background to-muted/20 shadow-md border-primary/10">
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>Update or add new product images.</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div
            ...
            <div className="sticky bottom-4 bg-background/95 p-4 rounded-lg shadow-lg backdrop-blur-md border border-muted">
              <div className="flex justify-between items-center">
                ...
                <Button type="submit" className="min-w-[150px]" disabled={isPending || isUploading}>
                  {isPending ? (
                    <>
                      <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                      Updating Product...
