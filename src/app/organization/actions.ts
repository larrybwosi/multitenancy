    ...
    const result = await prisma.$transaction(async (tx) => {
      const newOrg = await tx.organization.create({
        data: {
          ...
          slug: slug, // Use the generated/validated slug
          logo: logoUrl,
          metadata: validatedData.metadata || null,
          createdAt: new Date(), // Prisma handles default, but being explicit is ok
          // id is auto-generated by Prisma (cuid or uuid depending on schema)
        },
      });
      ...
      await tx.member.create({
        data: {
          ...
          role: "ADMIN", // Or 'OWNER', adjust as needed
          createdAt: new Date(),
        },
      });
