        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Customer Invoicing</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Account Pay</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Spend Management</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Financial Reports</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Open Banking</a></li>
            </ul>
          </div>
